...
const createOrderDocument = async (userId, addressId, paymentMethod, paymentStatus, discountAmount = 0, couponId) => {
    ...
    if (!address) throw new Error('Delivery address not found.')
        ...
        const effectiveUnitPrice = (lineTotal - discountForThisItem) / item.quantity
...
module.exports = { createOrderDocument }